...
describe('Raw Decoder', function () {
    ...
    it('should handle the Raw encoding', async function () {
        await testDecodeRect(decoder, 0, 0, 2, 2,
                             [0xff, 0x00, 0x00, 0,
                              0x00, 0xff, 0x00, 0,
                              0x00, 0xff, 0x00, 0,
                              0xff, 0x00, 0x00, 0],
                             display, 24);
        await testDecodeRect(decoder, 2, 0, 2, 2,
                             [0x00, 0x00, 0xff, 0,
                              0x00, 0x00, 0xff, 0,
                              0x00, 0x00, 0xff, 0,
                              0x00, 0x00, 0xff, 0],
                             display, 24);
        await testDecodeRect(decoder, 0, 2, 4, 1,
                             [0xee, 0x00, 0xff, 0,
                              0x00, 0xee, 0xff, 0,
                              0xaa, 0xee, 0xff, 0,
                              0xab, 0xee, 0xff, 0],
                             display, 24);
        await testDecodeRect(decoder, 0, 3, 4, 1,
                             [0xee, 0x00, 0xff, 0,
                              0x00, 0xee, 0xff, 0,
                              0xaa, 0xee, 0xff, 0,
                              0xab, 0xee, 0xff, 0],
    ...
    it('should handle empty rects in low colour mode', async function () {
        ...
        await testDecodeRect(decoder, 1, 2, 0, 0, [], display, 8);
